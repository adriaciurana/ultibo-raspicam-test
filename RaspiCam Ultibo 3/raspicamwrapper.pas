...
function RaspiCam_startCapture(handle: RaspiCam): Boolean; cdecl;
function RaspiCam_open(handle: RaspiCam; startCapture: Boolean): Boolean; cdecl;
function RaspiCam_grab(handle: RaspiCam): Boolean; cdecl;
...
function RaspiCam_save(image: RaspiCam_Image; filename: PChar): Boolean; cdecl;
function RaspiCam_getImage(handle: RaspiCam): RaspiCam_Image; cdecl;

// Functions
function RaspiCam_setAnnotate(handle: RaspiCam; enable: Boolean; str: PChar; size: cuint8; color: cuint8; bg_color: cuint8): Boolean; cdecl;
...
function RaspiCam_startCapture(handle: RaspiCam): Boolean; cdecl; external 'libraspicam' name 'RaspiCam_startCapture';
function RaspiCam_open(handle: RaspiCam; startCapture: Boolean) : Boolean; cdecl; external 'libraspicam' name 'RaspiCam_open';
function RaspiCam_grab(handle: RaspiCam): Boolean; cdecl; external 'libraspicam' name 'RaspiCam_grab';
...
function RaspiCam_save(image: RaspiCam_Image; filename: PChar): Boolean; cdecl; external 'libraspicam' name 'RaspiCam_save';
function RaspiCam_getImage(handle: RaspiCam): RaspiCam_Image; cdecl; cdecl; external 'libraspicam' name 'RaspiCam_getImage';

// Functions
function RaspiCam_setAnnotate(handle: RaspiCam; enable: Boolean; str: PChar; size: cuint8; color: cuint8; bg_color: cuint8): Boolean; cdecl; external 'libraspicam' name 'RaspiCam_setAnnotate';
end.
